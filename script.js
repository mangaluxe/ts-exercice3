...
function editContact(button) {
    ...
    if (contact) {
        const firstnameField = formEditContact.querySelector('input[name="firstname"]');
        const lastnameField = formEditContact.querySelector('input[name="lastname"]');
        const dateOfBirthField = formEditContact.querySelector('input[name="dateOfBirth"]');
        const emailField = formEditContact.querySelector('input[name="email"]');
        const phoneField = formEditContact.querySelector('input[name="phone"]');
...
formEditContact.addEventListener("submit", function (e) {
    e.preventDefault();
    const firstnameInput = formEditContact.querySelector('input[name="firstname"]');
    const lastnameInput = formEditContact.querySelector('input[name="lastname"]');
    const dateOfBirthInput = formEditContact.querySelector('input[name="dateOfBirth"]');
    const emailInput = formEditContact.querySelector('input[name="email"]');
    const phoneInput = formEditContact.querySelector('input[name="phone"]');
